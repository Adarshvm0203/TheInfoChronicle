...
const Science = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=0d4abe355cf641f3968145a740d38e5a"
      )
      .then((response) => {
  ...
  const top3LatestItems = articles.slice(1,4);
  const category = "science"; // Set the category dynamically
  ...
  return (
    <div className="container" style={customStyle}>
      <div className="animated-heading purple-heading ">
        <h1 className="heading-text">Science</h1>
      </div>
