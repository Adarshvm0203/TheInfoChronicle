...
const Business = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=0d4abe355cf641f3968145a740d38e5a"
      )
      .then((response) => {
  ...
  const category = "business"; // Set the category dynamically
  ...
  return (
    <div className="container" style={customStyle}>
      ...
      <div className="animated-heading orange-heading">
        <h1 className="heading-text">Business</h1>
      </div>
