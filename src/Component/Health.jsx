...
const Health = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=0d4abe355cf641f3968145a740d38e5a"
      )
      .then((response) => {
  ...
  const category = "health"; // Set the category dynamically
  ...
  return (
    <div className="container" style={customStyle}>
      <div className="animated-heading blue-heading">
        <h1 className="heading-text">Health</h1>
      </div>
