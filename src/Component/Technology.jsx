...
const Technology = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=0d4abe355cf641f3968145a740d38e5a"
      )
      .then((response) => {
  ...
  const top3LatestItems = articles.slice(0, 3);
  const category = "technology"; // Set the category dynamically
  ...
  return (
    <div className="container" style={customStyle}>
      <div className="animated-heading black-heading">
        <h1 className="heading-text ">Technology</h1>
      </div>
